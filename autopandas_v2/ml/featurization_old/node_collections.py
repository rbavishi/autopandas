...
from autopandas_v2.ml.featurization_old.graph import GraphNode, GraphEdgeType, GraphNodeType
                    ...
                    try:
                        ...
                        if val1 == val2:
                            for n1, n2 in itertools.product(nodes1, nodes2):
                                collector.add_edge(n1, n2, GraphEdgeType.EQUALITY)
            ...
            def adjacency_to_the_right(vals):
                for row_vals in vals:
                    for n1, n2 in zip(row_vals, row_vals[1:]):
                        collector.add_edge(n1, n2, GraphEdgeType.ADJACENCY)
